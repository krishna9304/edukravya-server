...
def encode(image_name, secret_data):
    ...
    n_bytes = max_data_to_encode(image)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-t", "--text", help="The text data to encode into the image, this only should be specified for encoding")
